...
class TeamMR extends StatefulWidget {
  const TeamMR({super.key});

  @override
  State<TeamMR> createState() => _TeamMRState();
}

class _TeamMRState extends State<TeamMR> {
                ...
                children: [
                  formatTab(
                    ...
                    onTap: () {
                      ...
                      setting.iccMenTeamRList.value =
                          setting.allRankingModel.value?.men?[1].t20?.teamRanking ?? [];
                    },
                    title: "T20",
                    value: 1,
                  ...
                  formatTab(
                    ...
                    onTap: () {
                      ...
                      setting.iccMenTeamRList.value =
                          setting.allRankingModel.value?.men?[0].odi?.teamRanking ?? [];
                    },
                    title: "ODI",
                    value: 2,
                    selectedValue: setting.battingMRF,
                  ...
                  formatTab(
                    ...
                    onTap: () {
                      ...
                      setting.iccMenTeamRList.value =
                          setting.allRankingModel.value?.men?[2].test?.teamRanking ?? [];
                    },
                    title: "Test",
                    value: 3,
                    selectedValue: setting.battingMRF,
              ...
              child: Obx(
                () => setting.isAllRanking.value
                    ...
                    : ListView.separated(
                        ...
                        itemCount: setting.iccMenTeamRList.length,
                        itemBuilder: (context, index) {
                          final data = setting.iccMenTeamRList[index];
                          return Row(
                            children: [
                              Expanded(
                                child: Row(
      ...
      () => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: selectedValue.value == value ? AppColor.sTabColor : AppColor.tDivider,
            ),
          ),
          child: Text(
            title,

              ...
              children: [
                formatTab(
                  ...
                  onTap: () {
                    ...
                    setting.iccMenTeamRList.value = setting.allRankingModel.value?.men?[1].t20?.teamRanking ?? [];
                  },
                  title: "T20",
                  value: 1,
                ...
                formatTab(
                  ...
                  onTap: () {
                    ...
                    setting.iccMenTeamRList.value = setting.allRankingModel.value?.men?[0].odi?.teamRanking ?? [];
                  },
                  title: "ODI",
                  value: 2,
                  selectedValue: setting.battingMRF,
                ...
                formatTab(
                  ...
                  onTap: () {
                    ...
                    setting.iccMenTeamRList.value = setting.allRankingModel.value?.men?[2].test?.teamRanking ?? [];
                  },
                  title: "Test",
                  value: 3,
                  selectedValue: setting.battingMRF,

...
class BowlingWr extends StatefulWidget {
  const BowlingWr({super.key});

  @override
  State<BowlingWr> createState() => _AllRounderMrState();
}

class _AllRounderMrState extends State<BowlingWr> {
                ...
                children: [
                  formatTab(
                    ...
                    onTap: () {
                      ...
                      setting.iccWomenBowlerRList.value =
                          setting.allRankingModel.value?.women?[1].t20w?.bowl ?? [];
                    },
                    title: "T20",
                    value: 1,
                  ...
                  formatTab(
                    ...
                    onTap: () {
                      ...
                      setting.iccWomenBowlerRList.value =
                          setting.allRankingModel.value?.women?[0].odiw?.bowl ?? [];
                    },
                    title: "ODI",
                    value: 2,
                    selectedValue: setting.battingWRF,
              ...
              child: Obx(
                () => setting.isAllRanking.value
                    ...
                    : ListView.separated(
                        ...
                        itemCount: setting.iccWomenBowlerRList.length,
                        itemBuilder: (context, index) {
                          final data = setting.iccWomenBowlerRList[index];
                          return Row(
                            children: [
                              showPlayer(
                                context: context,

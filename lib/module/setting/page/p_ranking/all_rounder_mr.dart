...
class AllRounderMr extends StatefulWidget {
  const AllRounderMr({super.key});

  @override
  State<AllRounderMr> createState() => _AllRounderMrState();
}

class _AllRounderMrState extends State<AllRounderMr> {
              ...
              children: [
                formatTab(
                  ...
                  onTap: () {
                    ...
                    setting.iccMenAllRounderRList.value = setting.allRankingModel.value?.men?[1].t20?.allrounder ?? [];
                  },
                  title: "T20",
                  value: 1,
                ...
                formatTab(
                  ...
                  onTap: () {
                    ...
                    setting.iccMenAllRounderRList.value = setting.allRankingModel.value?.men?[0].odi?.allrounder ?? [];
                  },
                  title: "ODI",
                  value: 2,
                  selectedValue: setting.battingMRF,
                ...
                formatTab(
                  ...
                  onTap: () {
                    ...
                    setting.iccMenAllRounderRList.value = setting.allRankingModel.value?.men?[2].test?.allrounder ?? [];
                  },
                  title: "Test",
                  value: 3,
                  selectedValue: setting.battingMRF,
            ...
            child: Obx(
              () => setting.isAllRanking.value
                  ...
                  : ListView.separated(
                      ...
                      itemCount: setting.iccMenAllRounderRList.length,
                      itemBuilder: (context, index) {
                        final data = setting.iccMenAllRounderRList[index];
                        return Row(
                          children: [

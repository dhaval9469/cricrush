                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                showPlayer(context: context, url: data?.image ?? '', w: context.wp(3), h: context.wp(3)),
                                SizedBox(width: context.wp(4)),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("${data?.name}", overflow: TextOverflow.ellipsis, style: tBarlow(context)),
                                    SizedBox(height: context.hp(0.3)),
                                    Text(data?.skillName ?? "", style: stDmSans(context, fontSize: context.sp(12))),
                                  ],
                                ),
                                Spacer(),
                                Column(

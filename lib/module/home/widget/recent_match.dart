...
class RecentMatch extends StatelessWidget {
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text("${data.teamaShort}", style: tDmSans(context, fontWeight: FontWeight.w600)),
                                          ],
                                        ),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            SizedBox(width: context.wp(3)),
                                            Text("${data.teambShort}", style: tDmSans(context, fontWeight: FontWeight.w600)),
                                          ],
                                        ),
                                      ],
                                    ),
  ...
  void passUpCData(HAllMatches? data) {
  ...
  void passComData(HAllMatches? data) {
  ...
  void passLiveData(HAllMatches? data) {
    mdCtrl.matchId.value = data?.matchdetail?.match?.code ?? "";
    mdCtrl.matchType.value = data?.matchdetail?.match?.number ?? "";
    mdCtrl.teamAFlag.value = data?.teamlist?[0].teamImage ?? "";
    mdCtrl.teamBFlag.value = data?.teamlist?[1].teamImage ?? "";
